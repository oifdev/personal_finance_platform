        ...
        <div className="glass-card p-6 rounded-xl h-fit">
            ...
            <form id="budget-form" action={handleSubmit} className="space-y-4">
                <div className="space-y-2">
                    ...
                    <select
                        name="category_id"
                        className="w-full px-3 py-2 bg-input border border-border rounded-lg text-sm text-foreground focus:outline-none focus:ring-2 focus:ring-[#38b6ff]/50"
                        required
                ...
                <div className="space-y-2">
                    ...
                    <div className="relative">
                        ...
                        <input
                            ...
                            placeholder="500.00"
                            className="w-full pl-8 pr-3 py-2 bg-input border border-border rounded-lg text-sm text-foreground focus:outline-none focus:ring-2 focus:ring-[#38b6ff]/50"
                        />
                    </div>
                </div>
                <button
